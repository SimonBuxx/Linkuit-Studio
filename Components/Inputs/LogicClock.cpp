    ...
    mDirection(pDirection)
{
    ...
    QObject::connect(this, &LogicClock::ShowClockConfiguratorSignal, pCoreLogic, &CoreLogic::OnShowClockConfiguratorRequest);
}
...
void LogicClock::mousePressEvent(QGraphicsSceneMouseEvent *pEvent)
{
    ...
    {
        emit ShowClockConfiguratorSignal(std::static_pointer_cast<LogicClockCell>(mLogicCell)->GetClockMode(),
...
SwVersion LogicClock::GetMinVersion() const
{
